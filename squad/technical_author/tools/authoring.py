"""
squad/technical_author/tools/authoring.py - the report-authoring surface.

Tools the Technical Author uses to turn the Vulnerability Researcher's
verified findings into H1-format disclosure reports: sanitise evidence,
cite remediation guidance (CWE / OWASP), compute the CVSS base score,
survey prior art, draft one report per finding, and consolidate every
draft into the ``reports.json`` artefact the Disclosure Coordinator
submits.
"""
